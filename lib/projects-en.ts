...
export const projectsEn: Project[] = [
  ...
  },
  {
    ...
    architecture: {
      ...
      alt: 'Architecture Sandbox logical architecture: the user creates an architecture inside the application and passes the diagram and rationale to design evaluation. Both capabilities exchange conversations and evaluations with Gemini. The user reviews the results to refine the design.',
    },
